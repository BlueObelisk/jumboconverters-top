...
//	public static final MimeType DALTON = new MimeType("chemical/x-dalton", ObjectType.TEXT,	".out");
	...
	//jmht - Mime types for individual converters defined within the converters (see e.g. NWChemModule.java)
...
//	public static final MimeType NWCHEM_IN = new MimeType("chemical/x-nwchem-input", ObjectType.TEXT,	"nwchem.input");
//	public static final MimeType NWCHEM_LOG = new MimeType("chemical/x-nwchem-log", ObjectType.TEXT,	"nwchem.log");
...
//		typeList.add(GAU_LOG);
		...
		typeList.add(N3);
		typeList.add(NAME);
//		typeList.add(NWCHEM_IN);
//		typeList.add(NWCHEM_LOG);
