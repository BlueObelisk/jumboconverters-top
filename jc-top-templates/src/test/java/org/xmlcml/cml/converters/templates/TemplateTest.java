...
public class TemplateTest {
	...
	String document1S = 				
		"<!DOCTYPE template SYSTEM 'src/main/resources/org/xmlcml/cml/converters/templates/input/text.dtd' [ " +
		"]>" +
		document0S;
	...
	public void testDTD() {
		String minimalS = "<?xml version='1.0' standalone='no'?>" +
				"<!DOCTYPE templates SYSTEM 'src/main/resources/org/xmlcml/cml/converters/templates/input/text.dtd' [ " +
				"]>" +
				"<templates/>";
		Element element = new CMLBuilder().parseString(minimalS);
		Assert.assertNotNull(element);
